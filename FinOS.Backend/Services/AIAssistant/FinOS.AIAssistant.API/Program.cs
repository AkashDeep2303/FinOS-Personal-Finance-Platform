...
using FinOS.AIAssistant.Application.Validators;
using FinOS.AIAssistant.Infrastructure.Extensions;
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "FinOS AI Assistant API", Version = "v1" });
