...
using FinOS.Budget.Application.Validators;
using FinOS.Budget.Infrastructure.Extensions;
...
// Infrastructure (ADO.NET / Dapper + IConnectionFactory + IUnitOfWork)
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "FinOS Budget API", Version = "v1" });
