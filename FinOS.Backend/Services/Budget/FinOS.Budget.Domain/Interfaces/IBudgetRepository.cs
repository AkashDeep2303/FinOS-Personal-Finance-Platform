...
public interface IBudgetRepository : IRepository<Domain.Entities.Budget>
{
    ...
    new Task UpdateAsync(Domain.Entities.Budget budget, CancellationToken ct = default);
    Task ReplaceCategoriesAsync(long budgetId, long userId, List<BudgetCategory> categories, CancellationToken ct = default);
