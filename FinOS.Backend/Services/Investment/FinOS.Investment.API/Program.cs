...
using FinOS.Investment.Application.Validators;
using FinOS.Investment.Infrastructure.Extensions;
...
// MediatR
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(CreatePortfolioCommand).Assembly));
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "FinOS Investment API", Version = "v1" });
