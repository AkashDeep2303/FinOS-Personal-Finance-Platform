...
using FinOS.EventBus.Extensions;
using FinOS.Identity.Application.Commands;
using FinOS.Identity.Application.Validators;
using FinOS.Identity.Infrastructure.Extensions;
...
// Event Bus (in-memory, no external dependencies)
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "FinOS Identity API", Version = "v1" });
