...
using FinOS.Analytics.Application.Validators;
using FinOS.Analytics.Infrastructure.Extensions;
...
// MediatR
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(CalculateNetWorthCommand).Assembly));

// FluentValidation
builder.Services.AddValidatorsFromAssemblyContaining<CalculateNetWorthCommandValidator>();
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "FinOS Analytics API", Version = "v1" });
