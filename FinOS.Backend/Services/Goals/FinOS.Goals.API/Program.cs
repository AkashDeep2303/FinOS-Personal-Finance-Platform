...
using FinOS.Goals.Application.Validators;
using FinOS.Goals.Infrastructure.Extensions;
...
// MediatR
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(CreateGoalCommand).Assembly));

// FluentValidation
builder.Services.AddValidatorsFromAssemblyContaining<CreateGoalCommandValidator>();
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "FinOS Goals API", Version = "v1" });
