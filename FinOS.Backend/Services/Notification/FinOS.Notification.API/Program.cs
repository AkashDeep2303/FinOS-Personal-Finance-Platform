...
using FinOS.Notification.Application.Validators;
using FinOS.Notification.Infrastructure.Extensions;
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "FinOS Notification API", Version = "v1" });
